...
##    global score, progress_bar, image

##    image.scale = 0.9
##    image.update()  

    
##    new_score = score.data + 1
##    score.data = new_score
##    score.value = str(new_score)

    
##    new_progress_value = min(progress_bar.value + 1, 100)  
##    progress_bar.value = new_progress_value
##    progress_bar.update()
...
#async def score_up(e):
#    global score, progress_bar, image, plus_one

    
#    plus_one.left = event.local_x
#    plus_one.opacity = 1.0
#    plus_one.update()
...
#    plus_one = ft.Text(value="+1", size=30, color="#0085a1", opacity=0.0)
...
#    compass = ft.Container(
#        content=ft.Stack(controls=[image, score_counter, plus_one]),
#        on_click=score_up,
#        margin=ft.Margin(0, 0, 0, 30),
