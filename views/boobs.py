...
class BoobsView(ft.View):
    def __init__(self, page: ft.Page, navbar: ft.NavigationBar):
        super(BoobsView, self).__init__(
            route="/", horizontal_alignment='center', vertical_alignment='center', bgcolor='#012531'
        )
        ...
        self.image = ft.Image(src='1 1.png', fit=ft.ImageFit.CONTAIN, animate_scale=ft.Animation(duration=600, curve=ft.AnimationCurve.EASE))
        self.progress_bar = ft.ProgressBar(value=0, width=self.page.width-60, bar_height=20, color='#007995', bgcolor='#003956')
        self.navbar = navbar
